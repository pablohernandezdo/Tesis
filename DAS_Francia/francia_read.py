...
def main():
    ...
    ani_tr = animation.ArtistAnimation(fig_tr, ims_tr, interval=200, blit=True, repeat=False)
    ...
    ani_sp = animation.ArtistAnimation(fig_sp, ims_sp, interval=200, blit=True, repeat=False)
