...
def main():
    ...
    for idx, trace in enumerate(trtp):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f'Imgs/Utah_{trtp_ids[idx]}')
    ...
    # ani_tr.save('Animations/Utah_traces.mp4')
    #
    ...
    # ani_sp.save('Animations/Utah_spectrums.mp4')
    ...
    # plt.ylabel('Strain [-]')
    # plt.xlabel('Tiempo [s]')
    # plt.title('Trazas DAS datos Utah')
    #
    # plt.subplot(312)
    ...
    # plt.ylabel('Strain [-]')
    # plt.xlabel('Tiempo [s]')
    # plt.title('Trazas DAS datos Utah filtrados 1 - 10 Hz')
    #
    # plt.subplot(312)
    ...
    # plt.xlabel('Muestras [-]')
    # plt.ylabel('Strain [-]')
    # plt.title('Traza STEAD y traza DAS Utah')
    # plt.legend(handles=[line_st, line_das], loc='upper left')
    # plt.savefig('Imgs/STEADUtah.png')
    #
    # plt.clf()
    # plt.subplot(211)
    # plt.plot(st_trace)
    ...
    # plt.xlabel('Muestras [-]')
    # plt.ylabel('Strain [-]')
    # plt.savefig('Imgs/STEADUtah1.png')
